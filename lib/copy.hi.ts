...
export const TEXT_EN = {
  ...
  aboutAgeExact: "Exact age",
  aboutAgeYounger: "Younger by one year",
  aboutAgeOlder: "Older by one year",
  aboutAgeAria: "Your age",
  ...
  landingFeatQuestionsSub: "one per screen, in order",
  landingFeatMinutes: "minutes",
  landingFeatMinutesSub: "mostly just tapping",
  landingFeatVoice: "you can just say out loud",
  landingFeatVoiceSub: "habits, products, treatments",
...
export const TEXT_HI: Record<TextKey, string> = {
  ...
  aboutAgeExact: "पूरी उम्र",
  aboutAgeYounger: "एक साल कम",
  aboutAgeOlder: "एक साल ज़्यादा",
  aboutAgeAria: "आपकी उम्र",
  ...
  landingFeatQuestionsSub: "एक स्क्रीन पर एक, क्रम से",
  landingFeatMinutes: "मिनट",
  landingFeatMinutesSub: "ज़्यादातर सिर्फ़ टैप करना",
  landingFeatVoice: "बोलकर भी बता सकते हैं",
  landingFeatVoiceSub: "आदतें, चीज़ें, इलाज",
