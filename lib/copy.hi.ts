...
export const TEXT_EN = {
  ...
  voiceCta: "Answer by speaking",
  voiceOff: "Answering by speaking is not set up on this device. Please tap your answers below.",
  voiceCtaAria: "Answer this question by speaking instead of tapping",
  voiceHint: "Say it in your own words. Hindi, English, or a mix.",
  voiceMention: "Please mention:",
  voiceExample: "For example:",
  voiceListening: "Listening",
  voiceStopFill: "Stop and fill in",
  voiceCancel: "Cancel",
  voiceWorking: "Filling in your answer",
  voiceAgain: "Speak again",
  voiceCheckAbove: "Check what was filled in above. Tap anything to change it.",
  voiceBlocked: "{option} does not apply to your answers, so it was left out.",
  voiceSeconds: "{n}s",
  editDone: "Done",
...
export const TEXT_HI: Record<TextKey, string> = {
  ...
  voiceCta: "बोलकर जवाब दें",
  voiceOff: "इस डिवाइस पर बोलकर जवाब देने की सुविधा चालू नहीं है। कृपया नीचे टैप करके जवाब दें।",
  voiceCtaAria: "टैप करने के बजाय बोलकर इस सवाल का जवाब दें",
  voiceHint: "अपने शब्दों में बोलें। हिंदी, अंग्रेज़ी या दोनों मिलाकर।",
  voiceMention: "कृपया ये बताएँ:",
  voiceExample: "जैसे:",
  voiceListening: "सुन रहे हैं",
  voiceStopFill: "रोकें और भरें",
  voiceCancel: "रहने दें",
  voiceWorking: "आपका जवाब भरा जा रहा है",
  voiceAgain: "दोबारा बोलें",
  voiceCheckAbove: "ऊपर भरे गए जवाब देख लें। बदलने के लिए उस पर टैप करें।",
  voiceBlocked: "{option} आपके जवाबों पर लागू नहीं होता, इसलिए इसे छोड़ दिया गया।",
  voiceSeconds: "{n} सेकंड",
  editDone: "हो गया",
